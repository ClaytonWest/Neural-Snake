...
class Snake():
  ...
  def run(self):
    ...
    font = pygame.font.Font('/Users/clayw/Library/Fonts/font3270.otf', 20)
    font.set_bold(True)
    ...
    while True:
      ...
      fitness_text = font.render("Fitness: " + str(int(self.fitness)), True, (255, 255, 255))
      # top_fitness= font.render("Top Fitness: " + str(int(self.genomes[0].fitness)), True, (255, 255, 255))
      self.s.blit(score_text, (5, 10))
      self.s.blit(fitness_text, (5, 25))
      # self.s.blit(top_fitness, (10, 70))
